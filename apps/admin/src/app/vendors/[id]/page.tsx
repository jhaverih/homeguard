  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-brand">{vendor.name}</h1>
          {vendor.companyName && <p className="text-gray-500 text-sm mt-1">{vendor.companyName}</p>}
          <p className="text-gray-400 text-xs mt-1">{vendor.email} · Joined {new Date(vendor.joinedAt).toLocaleDateString()}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <h2 className="text-sm font-bold text-gray-600 uppercase tracking-wide mb-4">Jobs — Last 6 Months</h2>
        ...
        {/* Rating breakdown */}
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <h2 className="text-sm font-bold text-gray-600 uppercase tracking-wide mb-4">Rating Breakdown</h2>
      ...
      {reviews.recent.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <h2 className="text-sm font-bold text-gray-600 uppercase tracking-wide mb-4">Recent Reviews</h2>
